...
- [x] Add tests for schema encode/decode round-trips
...
- [x] Add tests for all pure helpers
...
- [x] Add tests for all predicates and sort helpers
...
- [x] Add integration tests with temp directory and real YAML files
...
- [x] Apply perspective filters and sorts to task list — *needs:* Phase 4
- [x] Add tests for perspective loading and application
...
- [x] CLI smoke tests (round-trip create/get/list/update/delete)
